...
// ES5 way of doing it
function Vehicle3(name, wheels, passengers, speed) {
		this.name = name
		this.wheels = wheels
		this.passengers = passengers
		this.speed = speed
...
Vehicle3.prototype.vin = function() {
	console.log(this.name + "'s VIN: " + Math.random())
}

car3 = new Vehicle3('pink car', 4, 5, 100)
